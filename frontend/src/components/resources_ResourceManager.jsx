...
import { Cpu, Users, Calendar, AlertTriangle } from 'lucide-react';

export const ResourceManager = ({ projects, agents }) => {
  const resourceUtilization = useMemo(() => {
    const utilization = { agents: {}, projects: {}, overall: 0 };
            ...
            <div className="flex items-center space-x-3 p-4 bg-red-500/10 border border-red-500/20 rounded-lg">
              ...
              <div>
                ...
                <div className="text-red-300 text-sm">
                  {overallocatedAgents.map((a) => a.name).join(', ')} assigned to too many projects
                </div>
              </div>
            </div>
          )}
